function (AutoFiles _result _folder _base _pattern)
    if (ARGC GREATER 4)
        set(_exclude ${ARGN})
    else ()
        set(_exclude)
    ...
    foreach (_fname ${_files})
        if (IS_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/${_fname})
            AutoFiles (${_result} "${_fname}" "${_base}" "${_pattern}" "${_exclude}")
    ...
    if (NOT (folderFiles STREQUAL ""))
        ...
        set(${_result} ${${_result}} ${folderFiles} PARENT_SCOPE)
    endif ()
endfunction ()
